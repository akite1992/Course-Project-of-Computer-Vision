function [net] = new_refNet_initial(varargin)
...
net = add_block(net, opts, '1', 8, 8, 3, 96, 2, 0) ;
...
net = add_block(net, opts, '4', 3, 3, 192, 256, 1, 1) ;
...
net = add_block(net, opts, '5', 6, 6, 256, 512, 1, 0) ;
net = add_dropout(net, opts, '5') ;
net = add_block(net, opts, '5', 1, 1, 512, 512, 1, 0) ;
net = add_dropout(net, opts, '5') ;
